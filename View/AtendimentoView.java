...
public class AtendimentoView {
	...
	void view(char opcao, ArrayList<Atendimento> listAtendimento, ArrayList<Cliente> listCliente, ArrayList<Funcionario> listFuncionario, ArrayList<Servico> listServico, ArrayList<Veiculo> listVeiculo ) {		
		switch (opcao) {
		  case 'i':
		  ...
		  case 'a':
			  ...
			  do {
				  ...
				  System.out.println("CODIGO|   DATA ATENDIMENTO   |          NOME CLIENTE          |         SERVIÇO        | DESCRICAO ");
				  System.out.println(aAltera.getCodigo() + " | " + aAltera.getDia() + "/" + aAltera.getMes() + " | " + aAltera.getCliente().getNome() + " | " + aAltera.getServico().getDescricao() + " | " + aAltera.getDescricao());
		  ...
		  case 'c':
			  ...
			  if(aConsulta != null) {
				...
				System.out.println("CODIGO|   DATA ATENDIMENTO   |          NOME CLIENTE          |         SERVIÇO        | DESCRICAO ");
				System.out.println(aConsulta.getCodigo() + " | " + aConsulta.getDia() + "/" + aConsulta.getMes() + " | " + aConsulta.getCliente().getNome() + " | " + aConsulta.getServico().getDescricao() + " | " + aConsulta.getDescricao());
				System.out.println("====================");
			  }
			  else {
